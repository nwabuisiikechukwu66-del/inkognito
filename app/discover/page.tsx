    ...
    <div className="max-w-3xl mx-auto px-4 py-12 md:py-16">
      ...
      <div className="mb-12 overflow-x-auto no-scrollbar -mx-4 px-4 pb-4">
        <div className="flex items-center gap-3 min-w-max">
          <div className="p-3 text-[var(--dim)] mr-1 bg-[var(--surface)] rounded-full border border-[var(--border)]">
            <Filter size={18} />
          </div>
          {CATEGORIES.map((cat) => (
            <button
              ...
              className={clsx(
                "px-6 py-3 rounded-full border text-[13px] md:text-xs font-medium transition-all whitespace-nowrap",
                selectedCategory === cat.id
                  ? "bg-[var(--white)] border-[var(--white)] text-[var(--black)] shadow-xl scale-105"
